...
- **Component Reusability**: Whenever adding a new component from Shadcn or building a complex interactive UI element (like a custom combobox or dialog), automatically extract it into a reusable React component in the frontend/src/components/ folder for code reusability. Do not leave complex UI components hardcoded inline inside other files.
