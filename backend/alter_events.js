...
async function run() {
    try {
        await pool.query(`ALTER TABLE events ADD COLUMN IF NOT EXISTS start_date TEXT`);
        ...
        console.log("Successfully added start/end date/time columns to events table.");
    }
    catch (e) {
        console.error(e);
    }
